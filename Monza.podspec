...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Monza"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of Monza."
  ...
  # Or just: spec.author    = "alethadeu"
  # spec.authors            = { "alethadeu" => "alexandre.thadeu@icarros.com.br" }
  # spec.social_media_url   = "https://twitter.com/alethadeu"
